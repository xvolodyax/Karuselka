...
**Модель:** `gemini-3.8-flash` + `reasoning_effort=high` (канон: `gemini-3.8-flash-high`). Слайды, caption RU+EN, хуки, CTA — только Gemini 3.8 Flash High. Не inherit Director.
