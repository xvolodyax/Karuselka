...
**Модель:** `gemini-3.8-flash` + `reasoning_effort=high` (в Cloud Agents нет id `gemini-3.8-flash-high`, id модели строго `gemini-3.8-flash`). Хуки и dossier — только Gemini 3.8 Flash High. Не inherit Director.
