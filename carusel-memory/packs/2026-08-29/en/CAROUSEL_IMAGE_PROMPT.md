# CAROUSEL_IMAGE_PROMPT — EN — 2026-08-29
...
Same visual contract as RU. Family `animals_viktoria_collage`. Dark charcoal `#111111`–`#1a1a1a` + magenta `#ff006e` + white heavy sans. Type in-scene, no sticker halo.
...
- 01 cat — senses avoidance under tender words  
- 02 dog — waits at the closed door  
- 04 owl — sees the 100/0 contract  

## Copy

Verbatim from `carusel-memory/design/en/CAROUSEL_SLIDE_COPY.json`, in quotes. No extra labels. Never write «Сцена» / “Scene” as a title.  
Slide 09 CTA: "Comment LABELS" / "Audio reading in my app. Essence–Shadow–Vector." / "Write LABELS in the comments" / "Clarity now". No Academy, no URL, no bot.
...
Machine file: `carusel-memory/design/en/CAROUSEL_IMAGE_PROMPT.json`  
RU sibling: `carusel-memory/design/CAROUSEL_IMAGE_PROMPT.json`  
Next: **slice**. This step does not call Kie.
