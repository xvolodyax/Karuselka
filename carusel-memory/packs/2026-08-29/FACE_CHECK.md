...
forbidden: Alena / cover-refs/victoria.png / viktoriaref.png / victoria-sheet.png — not used
...
Looked at Виктория.png + ru/en slide-01/09 face crops with Read, plus iris-box samples
...
brown/grey = FAIL — not the Виктория.png lock. Not observed as a different eye on these slides.

## Pixel compare (01 / 09 vs Виктория.png)

### RU slide-01
- eyes: green + slight hazel (over-shoulder night key; iris still the lock mix, not grey)
- iris sample hue ~23.8° — same family as Виктория.png
...
- bone / age: same woman as 01 and Виктория.png
...
- iris sample hue ~19.0–23.2° — same family as Виктория.png (G>B, sat ~38–53%)
...
- iris sample hue ~21.9–22.5°, same mix as Виктория.png, not grey
- bone / age: same woman as EN 01 and lock
- hair: warm honey blonde + darker roots, not platinum
- clothes: petrol blouse + espresso jacket
- not Alena

brown/grey = FAIL — not observed on these four crops as a different eye from Виктория.png.
Platinum / generic older blonde / Alena = FAIL — not observed.

i2i this pack: carusel-memory/references/Виктория.png uploaded as Виктория.png.
Not viktoriaref.png. Not victoria-sheet.png. Not animals-viktoria-style-lock.png.
